<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mybook.aspx.cs" Inherits="mybook" %>
...
<body>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server"  AllowSorting="True" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:TemplateField HeaderText="房产ID">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="顾客姓名">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox5" runat="server" Text='<%# Bind("clientname") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                ...
                <asp:TemplateField HeaderText="预约时间"  SortExpression="bookdata">
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("bookdata") %>'></asp:TextBox>
                    </EditItemTemplate>
                    <FooterTemplate>
                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("bookdata") %>'></asp:TextBox>
                    </FooterTemplate>
                    <ItemTemplate>
    ...
    <p>
        <a href="HomePage.aspx"><input id="Button2" type="button" value="返回主界面" /><h1>    </h1>
